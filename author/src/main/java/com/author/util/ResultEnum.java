...
public enum ResultEnum {
	...
	DELETE_USER_SUCCESS(110024, "删除用户成功"), 
	DELETE_USER_ERROR(110025, "删除用户失败"),
	EDIT_USER_SUCCESS(110026, "删除用户成功"), 
	EDIT_USER_ERROR(110027, "删除用户失败"),
	DETAIL_USER_SUCCESS(110028, "获取用户成功"), 
	DETAIL_USER_ERROR(110029, "获取用户失败"),
	USER_ADN_PASS_ERROR(110030, "用户名或密码错误"), 
	GENERATE_TOKEN_SUCCESS(110031, "生成token成功"), 
	CANCEL_TOKEN_SUCCESS(110032, "token注销成功"),
	CANCEL_TOKEN_ERROR(110033, "token不存在"),
	USER_ADN_PASS_NULL_ERROR(110034, "用户名或密码不能为空"),
	CHECK_TOKEN_SUCCESS(110035, "token验证成功"), 

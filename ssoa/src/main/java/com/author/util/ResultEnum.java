...
public enum ResultEnum {
	...
	SAVE_AUTHORITY_SUCCESS(100003, "保存权限成功"), 
	SAVE_AUTHORITY_ERROR(110003, "保存权限失败"),
	DELETE_AUTHORITY_SUCCESS(100004, "删除权限成功"), 
	DELETE_AUTHORITY_ERROR(110004, "删除权限失败"),
	USER_NON_EXISTENT(110005, "用户不存在"), 
	USER_ROLE_NON_EXISTENT(110006, "当前登录用户没有角色信息"),
	ACHIEVE_AUTHORITY_SUCCESS(100007, "获取资源列表成功"), 
	ACHIEVE_AUTHORITY_ERROR(110007, "当前登录用户角色、权限信息有误"),
	...
	AUTHORITYNAME_NULL_ERROR(110040, "权限名称不能为空"),
	AUTHORITYURL_NULL_ERROR(110041, "权限URL不能为空"),
	SUBORDINATE_NULL_ERROR(110042, "权限所属不能为空"),
	AUTHORITYID_NULL_ERROR(110043, "权限ID不能为空"),
	...
	SAVE_PERMISSION_SUCCESS(100048, "保存权限成功"), 
	SAVE_PERMISSION_ERROR(110048, "保存权限失败"),
	DELETE_PERMISSION_SUCCESS(100049, "删除权限成功"), 
	DELETE_PERMISSION_ERROR(110049, "删除权限失败"),
	ACHIEVE_PERMISSION_SUCCESS(100050, "获取资源列表成功"), 
	ACHIEVE_PERMISSION_ERROR(110050, "当前登录用户角色、权限信息有误"),
	AUTHORITY_NON_EXISTENT(110051, "权限不存在"), 
	EDIT_AUTHORITY_SUCCESS(100052,"修改权限成功"),
	EDIT_AUTHORITY_ERROR(110052,"修改权限失败"),
	SEARCH_AUTHORITY_SUCCESS(100053,"查询权限成功"),
	SEARCH_AUTHORITY_ERROR(110053,"查询权限失败"),
	NO_SUCH_AUTHORITY_ERROR(110054,"当前登录用户没有该权限"),
	AUTHORITY_NOT_EXIT_ERROR(110055,"没有授权或授权已过期"),
	
	AUTHORITY_TYPE_NULL_ERROR(110056, "权限类型不能为空"),
	AUTHORITY_SUBORDINATE_SYSTEM_NULL_ERROR(110057, "权限所属系统不能为空"),
	AUTHORITY_SUBORDINATE_APP_NULL_ERROR(110058, "权限所属应用不能为空"),
	JEDIS_NOT_EXIT_ERROR(110059,"jedis获取失败"),
	
	DATABASE_CONNECTION_EXIT_ERROR(110060,"数据库连接获取失败"),
